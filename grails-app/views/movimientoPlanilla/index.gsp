...
<html>
	...
	<body>
		<a href="#list-movimientoPlanilla" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-movimientoPlanilla" class="content scaffold-list" role="main">
			...
			<thead>
				...
				<tbody>
				<g:each in="${movimientoPlanillaInstanceList}" status="i" var="movimientoPlanillaInstance">
			...
			<div class="pagination">
				<g:paginate total="${movimientoPlanillaInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
