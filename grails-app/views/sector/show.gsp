	...
	<body>
		...
		<div id="show-sector" class="content scaffold-show" role="main">
			...
			<ol class="property-list sector">
				...
				<g:if test="${sectorInstance?.codigo}">
				<li class="fieldcontain">
					<span id="codigo-label" class="property-label"><g:message code="sector.codigo.label" default="Codigo" /></span>
					
						<span class="property-value" aria-labelledby="codigo-label"><g:fieldValue bean="${sectorInstance}" field="codigo"/></span>
