...
<g:else>
    ...
    <div class="fieldcontain ${hasErrors(bean: facturaElectronicaInstance, field: 'tipoFactura', 'error')} ">
        ...
        <g:select id="tipoFactura" name="tipoFactura.id" from="${facturaElectronica.TipoFactura.list()}" optionKey="id" value="${facturaElectronicaInstance?.tipoFactura?.id}" optionValue="descripcion" class="many-to-one" noSelection="['null': '']"/>
