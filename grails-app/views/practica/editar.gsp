...
<div id="edit-practica" class="content scaffold-edit" role="main">
    ...
    <g:form url="[resource:practicaInstance, action:'updatePractica']" method="POST" >
        <g:hiddenField name="version" value="${practicaInstance?.version}" />
        <fieldset class="form">
            <g:render template="formulario"/>
        </fieldset>
        <fieldset class="buttons">
            <g:actionSubmit class="save" action="updatePractica"  value="${message(code: 'default.button.update.label', default: 'Update')}" />
        </fieldset>
    </g:form>
</div>
</body>
