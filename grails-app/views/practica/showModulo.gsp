   ...
   <tr><td>Practica</td>
    ...
    <g:form url="[resource:practicaInstance, action:'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="editModulo" id="${practicaInstance.id}" resource="${practicaInstance}" params="[valorPractica:valorPracticaInstance?.id]"><g:message code="default.button.editar.label" default="Edit" /></g:link>
