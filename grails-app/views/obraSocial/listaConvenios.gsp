...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'convenio.label', default: 'Convenios')}" />
...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link class="create" action="create"><g:message code="convenio.new.label" args="[entityName]" /></g:link></li>
    </ul>
</div>
<div id="list-obraSocial" class="content scaffold-list" role="main">
    ...
    <br />
    <div id="grid">
        <g:render template="grillaConvenios" model="model" />
    </div>
    <br />
