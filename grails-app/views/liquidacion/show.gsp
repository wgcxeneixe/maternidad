		...
		<div id="show-liquidacion" class="content scaffold-show" role="main">
                ...
                <table>
                    ...
                    <g:each in="${liquidacionInstance?.detallesLiquidacion}" status="i" var="detalleLiquidacionInstance">
                        <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                            ...
                            <td><g:link action="show" id="${detalleLiquidacionInstance.id}">${fieldValue(bean: detalleLiquidacionInstance, field: "conceptoPorProfesional.conceptoProfesional.nombre")}</g:link></td>
			...
			<g:form url="[resource:liquidacionInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					%{--<g:link class="edit" action="edit" resource="${liquidacionInstance}"><g:message code="default.button.editar.label" default="Edit" /></g:link>--}%
