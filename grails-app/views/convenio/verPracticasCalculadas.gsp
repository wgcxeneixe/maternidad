...
<div class="nav" role="navigation">
    <ul>
        <li><g:link class="create" action="editPlan" id="${params?.planConvenio}" ><g:message code="defaul.button.volver.label" /></g:link></li>
    </ul>
</div>
<div id="list-practica" class="content scaffold-list" role="main">
    ...
    <div class="filters">
        <g:form action="verPracticasCalculadas" params="[planConvenio:params?.planConvenio]">
    ...
    <br />
    <div id="grid">
        <g:render template="grillaCalculadas" model="model"  />
    </div>
    <br />
