...
<div id="create-practicaModulo" class="content scaffold-create" role="main">
    ...
    <g:form url="[resource:practicaModuloInstance, action:'updateAsociacionPractica']" >
        <fieldset class="form">



            <g:hiddenField name="valorPractica.id" value="${valorPractica?.id}"/>
            <g:hiddenField name="planConvenio.id" value="${valorPractica?.planConvenio?.id}"/>
            ...
            <div class="fieldcontain  required">
                ...
                <g:select id="practica" name="practica.id" from="${maternidad.Practica.list()}" value="${valorPractica?.practica?.id}" optionKey="id" required=""  class="many-to-one"/>
            ...
            <div class="fieldcontain required ">
                ...
                <g:field type="number" step="any" name="valor" required="" value="${valorPractica?.valorHonorario}" />
