		...
		<div id="list-componente" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombre" title="${message(code: 'componente.nombre.label', default: 'Nombre')}" />
				...
				<g:each in="${componenteInstanceList}" status="i" var="componenteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${componenteInstance.id}">${fieldValue(bean: componenteInstance, field: "nombre")}</g:link></td>
