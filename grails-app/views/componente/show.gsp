	...
	<body>
		...
		<div id="show-componente" class="content scaffold-show" role="main">
			...
			<ol class="property-list componente">
				...
				<g:if test="${componenteInstance?.nombre}">
				<li class="fieldcontain">
					<span id="nombre-label" class="property-label"><g:message code="componente.nombre.label" default="Nombre" /></span>
					
						<span class="property-value" aria-labelledby="nombre-label"><g:fieldValue bean="${componenteInstance}" field="nombre"/></span>
			...
			<g:form url="[resource:componenteInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${componenteInstance}"><g:message code="default.button.editar.label" default="Edit" /></g:link>
